...
bad_chars = ['ï»¿', 'Ã¯Â»Â¿']
splashText= ["The Robot Revolution Has Began", "The Router Has Become Sentient", "Enter The Matrix", "Sky Net Is Here", "CIMS Is Better Than POE", "Its DE Friday", "Auto Works"]
